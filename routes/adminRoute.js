 ...
 */
router.post('/courses',authenticate,IsAdmin, AdminController.createCourse);
/**
 * @swagger
 * /courses/{id}:
 *   put:
 ...
 *         description: Internal Server Error
 */
router.put('/courses/:id',authenticate,IsAdmin, AdminController.updateCourse);
/**
 * @swagger
 * /courses/{id}:
 *   delete:
 ...
 *         description: Internal Server Error
 */
router.delete('/courses/:id',authenticate,IsAdmin, AdminController.deleteCourse);
 ...
 *         description: Internal Server Error
 */
router.post('/admin/enrol', authenticate,IsAdmin, AdminController.enrolStudent);
/**
 * @swagger
 * /admin/remove:
 *   post:
 ...
 *         description: Internal Server Error
 */
router.post('/admin/remove',authenticate,IsAdmin,AdminController.removeStudent);
