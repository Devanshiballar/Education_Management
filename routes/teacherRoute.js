 ...
 */
router.post('/courses/:id/assignments',authenticate,IsTeacher,TeacherController.addAssignment);
/**
 * @swagger
 * /courses/{id}/quizzes:
 *   post:
 ...
 *         description: Internal Server Error
 */
router.post('/courses/:id/quizzes', authenticate,IsTeacher,TeacherController.createQuiz);
...
//grade 
router.post('/teacher/assign-grade', authenticate,IsTeacher, TeacherController.assignGrade);
