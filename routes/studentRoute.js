...
const StudentController=require("../controller/studentontroller");
 ...
 */
router.post('/courses/:id/enroll', authenticate,IsStudent,StudentController.enrollInCourse);
 ...
 *         description: Internal Server Error
 */
router.post('/assignments/:id/submit',authenticate,IsStudent,upload.single("file"),StudentController.submitAssignment);
 ...
 *         description: Internal Server Error
 */
router.get('/student/enrolments', authenticate,IsStudent, StudentController.viewEnrolments);
 ...
 *         description: Internal Server Error
 */
router.get('/student/courses/:courseId/assignments', authenticate,IsStudent, StudentController.viewAssignments);
 ...
 *         description: Internal Server Error
 */
router.get('/student/grades', authenticate,IsStudent,StudentController.viewGrades);
